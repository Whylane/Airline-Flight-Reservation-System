...
@section('title', 'Passenger History')
@section('content')
  <!-- Passenger Lists Start -->
  <div class="container-fluid pt-4 px-4">
    <div class="bg-secondary rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="mb-0">Passenger History Lists</h5>
            <a href="{{ url('admin/passenger') }}" class="btn btn-warning"><i class="material-icons opacity-10"></i>Passenger Lists</a>
        </div>
