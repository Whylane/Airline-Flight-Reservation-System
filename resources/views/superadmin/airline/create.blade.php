                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="returnFlightNumber">Return Flight Number Prefix</label>
                                    <input type="text" class="form-control" id="returnFlightNumber" name="return_flight_number" maxlength="2" required>
