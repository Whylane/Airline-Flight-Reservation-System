...
@section('title', 'Passenger History Lists')
@section('content')
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Passenger History Lists</h1>
    <ol class="breadcrumb">
      {{-- <li class="breadcrumb-item"><a href="./">Home</a></li> --}}
      <li class="breadcrumb-item">Passengers</li>
      <li class="breadcrumb-item active" aria-current="page">Passenger History Lists</li>
    </ol>
  </div>
          <!-- Row -->
          <div class="row">
